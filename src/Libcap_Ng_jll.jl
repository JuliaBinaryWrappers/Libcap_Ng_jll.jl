...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Libcap_Ng_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5ee47f88-1586-5e41-8c7a-ccc44ca77d79"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Libcap_Ng", artifacts_toml) for e in artifacts["Libcap_Ng"]]
...
if best_platform === nothing
    @debug("Unable to load Libcap_Ng; unsupported platform $(triplet(platform_key_abi()))")
else
